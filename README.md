...
- **Books**: *Sombras, Datos y Relámpagos*, *La Sospecha Razonable*, *No apagues la luz* (horror, 11 stories + prologue, full bilingual web edition: 13 EN chapters + 13 ES chapters), and *Huella* (forthcoming). Available on [Amazon](https://www.amazon.com/stores/Ernesto-Cisneros-Cino/author/B0FP5KBFNN) and via Stripe ($3.99 PDF).
